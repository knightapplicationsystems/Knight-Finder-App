...
//@interface KnightFinderObject : NSObject
//@end

@interface KnightFinderObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KnightFinderObject class]])
		{
			for (NSString *key in [[(KnightFinderObject*)o modules] allKeys])
			{
