...
// in simulator we redefine to format for KnightFinder Developer console
...
{\
	NSString * exceptionName = [@"org.knightfinder." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.knightfinder";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIKnightFinderNativeItemNone = -1, 
	UIKnightFinderNativeItemSpinner = -2,
	UIKnightFinderNativeItemProgressBar = -3,
	
	UIKnightFinderNativeItemSlider = -4,
	UIKnightFinderNativeItemSwitch = -5,
	UIKnightFinderNativeItemMultiButton = -6,
	UIKnightFinderNativeItemSegmented = -7,
	
	UIKnightFinderNativeItemTextView = -8,
	UIKnightFinderNativeItemTextField = -9,
	UIKnightFinderNativeItemSearchBar = -10,
	
	UIKnightFinderNativeItemPicker = -11,
	UIKnightFinderNativeItemDatePicker = -12,
	
	UIKnightFinderNativeItemInfoLight = -13,
	UIKnightFinderNativeItemInfoDark = -14,
	
	UIKnightFinderNativeItemDisclosure = -15,
	
	UIKnightFinderNativeItemContactAdd = -16
};
